...
# get-docker.sh neutralized — removed from repo to undo Docker setup per request.
# If you need the official install script in future, fetch it from
# https://get.docker.com or the Docker docs instead of keeping it in the repo.
